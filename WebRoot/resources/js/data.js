...
function  load_data(rid){
      ...
      $("#sub_time").html("");
		$("#sub_time").text(" 计量时间（日）:"+day+"天"+hour+"时"+min+"分") ;
	     ...
	     if(rid==75506330001||rid==75506330002||rid==75506330003||rid==75501330022||rid==75501330023||rid==75501330024||rid==75501330026){
    	...
    	//	console.log(waterquality)
	       ...
	       lastDayMinDo="-";
    			...
    			if(pollutantss.realFlu!=null&&pollutantss.maxFlu!=null&&pollutantss.minFlu!=null){
   				 if(pollutantss.realFlu==0&&pollutantss.maxFlu==0&&pollutantss.minFlu==0){
   					 var realFlu='-';
	                    var maxFlu='-'; //	
	                     var minFlu='-'; //
   				 }else{
   				var realFlu=pollutantss.realFlu.toFixed(3);   //有机碳
	                var maxFlu=pollutantss.maxFlu.toFixed(3);   //有机碳
	              var minFlu=pollutantss.minFlu.toFixed(3);   //有机碳
   				 }
   			 }else{
   				      var realFlu='-';
	                    var maxFlu='-'; //	
    			...
    			if(pollutantss.realcu!=null&&pollutantss.minni!=null&&pollutantss.mincu!=null){
    	...
    	/*	var thh22="<th align='center' style='font-family: 微软雅黑;font-size: 16px;'>溶解氧(mg/l)</th>";
				thh22+=" <th style='color: blue;' align='center' class='font_num'>"+realDo+"</th>";	
				thh22+=" <th style='color: red;' align='center' class='font_num'>"+lastDayMaxDo+"</th>";
				thh22+=" <th style='color: red;' align='center' class='font_num'>"+lastDayMinDo+"</th>";
				thh22+=" <th style='color: red;' align='center' class='font_num'>-</th>";
		  $thh22 = $(thh22);
           清除数据           $("#Do").empty();
    	...
    	//	}
		  ...
		  $th111 = $(th111);
           ...
           //添加td
    		...
    		var th112="<th align='center' style='font-family: 微软雅黑;font-size: 16px;'>氟化物(mg/l)</th>";
			th112+=" <th style='color: #0071BC;' align='center' class='font_num'>"+realFlu+"</th>";	
			th112+=" <th style='color: red;' align='center' class='font_num'>"+maxFlu+"</th>";
			th112+=" <th style='color: red;' align='center' class='font_num'>"+minFlu+"</th>";
			th112+=" <th align='center'>-</th>";
		//}
	  ...
	  $th112 = $(th112);
       ...
       //添加td
		...
		var th113="<th align='center' style='font-family: 微软雅黑;font-size: 16px;'>总铜(mg/l)</th>";
		th113+=" <th style='color: #0071BC;' align='center' class='font_num'>"+realcu+"</th>";	
		th113+=" <th style='color: red;' align='center' class='font_num'>"+maxcu+"</th>";
		th113+=" <th style='color: red;' align='center' class='font_num'>"+mincu+"</th>";
		th113+=" <th align='center'>-</th>";
	//}
  ...
  $th113 = $(th113);
   ...
   //添加td
	$("#Cu").append($th113);
	var th114="<th align='center' style='font-family: 微软雅黑;font-size: 16px;'>总镍(mg/l)</th>";
	th114+=" <th style='color: #0071BC;' align='center' class='font_num'>"+realni+"</th>";	
	th114+=" <th style='color: red;' align='center' class='font_num'>"+maxni+"</th>";
	th114+=" <th style='color: red;' align='center' class='font_num'>"+minni+"</th>";
	th114+=" <th align='center'>-</th>";
//}
...
var th115="<th align='center' style='font-family: 微软雅黑;font-size: 16px;'>总锌(mg/l)</th>";
th115+=" <th style='color: #0071BC;' align='center' class='font_num'>"+realzn+"</th>";	
th115+=" <th style='color: red;' align='center' class='font_num'>"+maxzn+"</th>";
th115+=" <th style='color: red;' align='center' class='font_num'>"+minzn+"</th>";
th115+=" <th align='center'>-</th>";
//}
...
$("#Zn").append($th115);
		...
		//console.log(pollutantName)
    		...
    		//  console.log(s3)
    		  for(var i=3;i<s3.rows.length;i++){
